...
```{r all ucr, fig.height=3, fig.width=10}
...
```{r hom chart, fig.height=7, fig.width=10}
...
```{r chart shot gun, fig.height=7, fig.width=10}
...
```{r chart gun, fig.height=12, fig.width=10}
...
```{r arrest bucket chart, echo=TRUE}
arrest_bucket_year %>% 
...
table %>%  
  ...
  labs(title = "Chicago District Demographics, % All Arrests Proactive Policing",
       caption = "Source: Chicago PD data, 2013 - 2019")
...
```{r arrest dist chart, fig.height=10, fig.width=10}
...
staff %>%
  ...
  labs(title = "Chicago Police Department Sworn Officer Unit Assignment",
       caption = "Source: Chicago PD swown officer data, 2000 - 2016")
